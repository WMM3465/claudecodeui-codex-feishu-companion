...
export type SidebarProjectListProps = {
  ...
  hiddenSessionsByProject: HiddenSessionsByProject;
  expandedHiddenProjects: Set<string>;
      ...
      {!showProjects
        ...
        : filteredProjects.map((project) => (
            <SidebarProjectItem
              ...
              hiddenSessionIds={hiddenSessionsByProject[project.name] || []}
              isHiddenSectionExpanded={expandedHiddenProjects.has(project.name)}
