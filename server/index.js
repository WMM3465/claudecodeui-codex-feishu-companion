...
import { validateApiKey, authenticateLocalOnly, authenticateToken, authenticateWebSocket } from './middleware/auth.js';
...
// Shared Feishu + desktop workspace state (protected)
app.use('/api/shared-workspace', authenticateToken, sharedWorkspaceRoutes);
app.use('/api/local-shared-workspace', authenticateLocalOnly, sharedWorkspaceRoutes);
